...
class TestUserMessageRouting(object):
    ...
    def test_01_start(self):
        ...
        for i, nw in enumerate(networkings):
            ...
            networkings[i] = bbc_network.BBcNetwork(core=dummy_cores[i], config=config)
